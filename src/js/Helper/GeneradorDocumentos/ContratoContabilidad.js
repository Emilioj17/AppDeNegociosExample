...
export const ContratoContabilidad = (datos) => {
    ...
    doc.setFontSize(20)
    doc.text("CONTRATO PRESTACIÓN SERVICIOS DE CONTABILIDAD.", 5, 25);
    doc.line(5, 26, 205, 26);
    doc.setFontSize(12);
    doc.setFont("arial", "normal");
    var text1 = `En Santiago de Chile, a ${fecha}, entre DENEGOCIOS.CL SpA, Rut 76.717.904-9, domiciliados en Ahumada 254, oficinas 806 y 903, Comuna de Santiago Centro, Región Metropolitana, en lo sucesivo los “PRESTADORES” y ${razon}, Rut: ${rutEmpresa}, representada legalmente por don/doña ${nombre}, Rut: ${rut}, de nacionalidad ${nacionalidad}, en lo sucesivo “EL CLIENTE”, se ha convenido el siguiente contrato de prestaciónde servicios.`
    var splitTitle1 = doc.splitTextToSize(text1, 190);
    doc.text(10, 40, splitTitle1);
    doc.setFont("arial", "bold");
    doc.text("PRIMERO", 10, 67);
    doc.line(10, 68, 30, 68)
    doc.setFont("arial", "normal");
    var text2 = "El cliente contrata a DENEGOCIOS.CL SpA, para que preste servicios en calidad de CONTADOR para realizar las siguiente labores:"
    var splitTitle2 = doc.splitTextToSize(text2, 190);
    doc.text(10, 73, splitTitle2);
    doc.text("a) Declaración de impuestos mensuales en el Formulario 29.", 20, 84);
    doc.text("b) Confección de libro de compra y ventas.", 20, 90);
    var text3 = "c) Confección de contratos de trabajos, liquidaciones de sueldos, finiquitos, libros de remuneraciones, cuando correspondiere.";
    var splitTitle3 = doc.splitTextToSize(text3, 180);
    doc.text(20, 96, splitTitle3);
    doc.text("d) Asesoría contable.", 20, 107);
    doc.setFont("arial", "bold");
    doc.text("SEGUNDO", 10, 115);
    doc.line(10, 116, 30, 116)
    doc.setFont("arial", "normal");
    var text4 = "Los honorarios del servicio de contabilidad se regirán acorde a la siguiente tabla de precios/tarifas.";
    var splitTitle4 = doc.splitTextToSize(text4, 180);
    doc.text(10, 122, splitTitle4);
    doc.setDrawColor(0)
    ...
    var text5 = "El tramo del valor del servicio se calcula mensualmente acorde a las ventas de la empresa, por lo que el valor mensual de los servicios contables puede variar en el mes a mes. Por ejemplo: Si en el mes de Marzo, la empresa No tuvo movimientos, corresponde a un cobro de $10.000 por una“Declaración SIN Movimiento”. Si al mes siguiente, Abril, la empresa tuvo ventas por 15 millones de pesos, corresponde a un cobro de $80.000 por una declaraciónde “Ventas sobre o iguales a 10 millones”. Si al mes subsiguiente, Mayo, la empresa vende 4 millones de pesos, corresponde a un cobro de $25.000 por unadeclaración de “Ventas menores o iguales a 5 millones”.";
    var splitTitle5 = doc.splitTextToSize(text5, 190);
    doc.text(10, 218, splitTitle5);
    var text6 = "Cualquiera de los tramos anteriormente señalados incluye las remuneraciones de hasta 2 trabajadores, dueños de empresa inclusive. A partir del tercer trabajador, se pagará adicional $4.500 por cada uno. Los finiquitos no aplican a la anterior regla, y por cada finiquito redactado se adicionará al valor mensual $2.500 independientemente del tramo en el que se encuentre la venta mensual.-";
    ...
    doc.setFont("arial", "normal");
    doc.text("No están incluidos dentro de los servicios señalados anteriormente:", 10, 22);
    doc.text("- Recepción de dinero y pago de Impuestos o Cotizaciones.", 15, 28);
    doc.text("- Retiro de Documentos.", 15, 34);
    var text1 = "- Contratos Laborales Especiales o con cláusulas particulares que requieran la intervención de un abogado para su redacción o que estén por fuera de los modelos actualmente estandarizados para la gran mayoría de las empresas.";
    var splitTitle1 = doc.splitTextToSize(text1, 185);
    doc.text(15, 40, splitTitle1);
    doc.text("- Trámites o Procesos relacionados a la Inspección del Trabajo, dígase F30, F30-1 y similares.", 15, 55);
    doc.text("- Representación ante el Servicio de Impuestos Internos ante fiscalizaciones y otros.", 15, 61);
    doc.text("- Emisión de Facturas y otros Documentos Tributarios Electrónicos o en Físico.", 15, 67);
    doc.text("- Emisión de Carpetas Tributarias.", 15, 73);
    doc.text("- Trámites electrónicos o presenciales ante la Inspección del Trabajo, AFC,Fonasa, Isapres, AFP.", 15, 79);
    var text2 = "- Preparación de Inventarios, Balances, auditorias, defensorías tributarias, confección de declaraciones juradas, confecciones de declaraciones de Rentas, reclamación de impuestos.";
    var splitTitle2 = doc.splitTextToSize(text2, 185);
    doc.text(15, 85, splitTitle2);
    var text2 = "Dado el caso, se pagarán como extraordinarios los trabajos anteriores si es que DENEGOCIOS.CL SpA acepta realizar dichas gestiones. Esto, previo acuerdo porescrito entre las partes.";
    var splitTitle2 = doc.splitTextToSize(text2, 190);
    ...
    doc.line(10, 116, 30, 116)
    doc.setFont("arial", "normal");
    var text3 = "En lo que respecta al período que llamaremos “Declaración de Renta”. Esto es: El Balance Anual, la Declaración de Impuesto a la Renta F22, las declaraciones Juradas de Horarios, Sueldos y Retiros, además de la Determinación de Capital Propio Tributario, Renta Líquida Imponible y FUT, documentos y libros necesarios para la Confección del F/22 Declaración de Renta; y otros relacionados a la “Declaración de Renta”.";
    var splitTitle3 = doc.splitTextToSize(text3, 190);
    doc.text(10, 122, splitTitle3);
    var text4 = "Lo anterior, podrá ser tomado por EL CLIENTE como servicio adicional prestado por DENEGOCIOS.CL SpA. Esto es opcional y para nada involucra una obligación para el cliente. Si es que el cliente decide aceptar este servicio adicional, este tendrá un costo adicional de $150.000 para empresa y no tiene relación algunacon el costo del Servicio mensual. Las condiciones de este servicio, así como su valor final, serán confirmados por DENEGOCIOS.CL SpA a su debido tiempo. Por lo demás, el cliente podrá consultar por ellos y contratar en cualquier momento. DENEGOCIOS.CL SpA no se hará responsable por multas asociadas a la no presentación de “Declaración de Renta” asociadas a la No Contratación de este Servicio con nuestra empresa.";
    ...
    doc.setFont("arial", "normal");
    var text5 = "Los honorarios del servicio serán informados por el prestador a su debido tiempo, esto a lo menos 5 días antes del día 30 de cada mes. Los honorarios del servicio deberán ser cancelados directamente a DENEGOCIOS.CL SpA como máximo los días 5 del mes siguiente a lo informado, en dinero efectivo directamente en las oficinas del prestador, transferencia o depósito a la cuenta que el prestador indique.";
    var splitTitle5 = doc.splitTextToSize(text5, 190);
    doc.text(10, 192, splitTitle5);
    var text6 = "Si el pago se realiza vía transferencia o depósito, deberán ser realizados a la siguiente cuenta:";
    var splitTitle6 = doc.splitTextToSize(text6, 190);
    ...
    doc.setFont("arial", "normal");
    var text5 = "Queda expresamente pactado que el presente contrato no crea exclusividad entre las partes, por lo que sí es voluntad del CLIENTE, éste podrá contratar cualquier servicio igual o similara los proporcionados por EL PRESTADOR, con la persona o personas, físicas o morales, nacionales o extranjeras que a sus intereses convenga, sin necesidad de notificarlo al PRESTADOR.";
    var splitTitle5 = doc.splitTextToSize(text5, 190);
    ...
    doc.setFont("arial", "normal");
    var text1 = "El presente contrato no presentade manera tácita o expresa, cualquier tipo de alianza, sociedad, asociación, asociación en participación, o transferencia de acciones, o participación de alguna en la capital social y/o patrimonio según aplique, de cada una de las partes, así como tampoco aplica una relación laboral entre éstas, por lo que se manifiesta en este acto la independencia de ambas partes respecto a sus derechos y obligaciones derivados de la celebración de este contrato, en relación con terceros.";
    var splitTitle1 = doc.splitTextToSize(text1, 190);
    doc.text(10, 27, splitTitle1);
    var text2 = "No obstante lo anterior, el PRESTADOR se obliga a proporcionar los serviciosobjeto de este contrato, de la manera que EL CLIENTE se lo solicite o instruye ysiempre en escrito apego a las leyes y procedimientos que en su caso seanaplicables.";
    var splitTitle2 = doc.splitTextToSize(text2, 190);
    ...
    doc.setFont("arial", "normal");
    var text3 = "Cualquier tipo de notificación entre las partes deberá ser por escrito vía correo electrónico, copiando expresamente a contabilidad@denegocios.cl y a contacto@denegocios.cl.";
    var splitTitle3 = doc.splitTextToSize(text3, 190);
    ...
    doc.setFont("arial", "normal");
    var text6 = "Las multas e intereses por el pago fuera de plazo de las obligaciones tributarias y previsionales del cliente serán de su exclusiva responsabilidad, no así, ya sea por olvido u omisión involuntaria de parte de DENEGOCIOS.CL SpA, quien será este último el que costeara dichos cargos.";
    var splitTitle6 = doc.splitTextToSize(text6, 190);
    ...
    doc.setFont("arial", "normal");
    var text7 = "Para la interpretación y cumplimiento de estecontrato, las partes se someten expresamente a las leyes y tribunales de la ciudadde Santiago, Chile, renunciando a cualquier otro fuero que pudieracorresponderles por razón de sus domicilios presentes o futuros o por cualquierotra causa.";
    var splitTitle7 = doc.splitTextToSize(text7, 190);
