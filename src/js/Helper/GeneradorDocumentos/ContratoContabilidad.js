...
export const ContratoContabilidad = (datos) => {
  ...
  const doc = new jsPDF();
    ...
    doc.text("a) Declaración de impuestos mensuales en el Formulario 29.", 20, 89);
    ...
    var text2 = "Dado el caso, se pagarán como extraordinarios los trabajos anteriores si es que DENEGOCIOS.CL SpA acepta realizar dichas gestiones. Esto, previo acuerdo por escrito entre las partes.";
    var splitTitle2 = doc.splitTextToSize(text2, 190);
    ...
    var text2 = "No obstante lo anterior, el PRESTADOR se obliga a proporcionar los servicios objeto de este contrato, de la manera que EL CLIENTE se lo solicite o instruye y siempre en escrito apego a las leyes y procedimientos que en su caso sean aplicables.";
    var splitTitle2 = doc.splitTextToSize(text2, 190);
    ...
    doc.setFont("arial", "normal");
    doc.text("Este contrato nopodrá ser modificado o alterado, excepto mediante acuerdo por escrito, firmado por ambas partes.", 10, 128);
    doc.setFont("arial", "bold");
    ...
    doc.setFont("arial", "normal");
    var text7 = "Para la interpretación y cumplimiento de este contrato, las partes se someten expresamente a las leyes y tribunales de la ciudad de Santiago, Chile, renunciando a cualquier otro fuero que pudiera corresponderles por razón de sus domicilios presentes o futuros o por cualquierotra causa.";
    var splitTitle7 = doc.splitTextToSize(text7, 190);
