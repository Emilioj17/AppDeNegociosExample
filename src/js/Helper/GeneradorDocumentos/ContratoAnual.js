...
export const ContratoAnual = (datos, img) => {
    ...
    doc.setFont("arial", "normal");
    var text10 = "Las partes fijan la renta anual de sub arriendo por la oficina en $100.00 (cien mil pesos) la que deberá ser pagada anticipadamente entre los días 1 y 5 De cada año en la recepción ubicada en el interior de la oficina, mediante transferencia bancaria odinero efectivo."
    ...
    doc.save(`Contrato Arriendo Anual para ${razon}.pdf`);
  }