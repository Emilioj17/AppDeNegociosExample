...
export const Contrato30dias = (datos, img) => {
    ...
    doc.text(10, 207, splitTitle7);
    doc.setFont("arial", "bold");
    doc.setFontSize(12);
    doc.text("5° TERMINACIÓN ANTICIPADA DEL CONTRATO", 10, 230);
    doc.line(10, 231, 110, 231);
    doc.setFont("arial", "normal");
    ...
    doc.text(10, 238, splitTitle8);
    doc.setFont("arial", "bold");
    doc.text("1. Si destina la oficina a cualquier otro fin que no sea el indicado en este instrumento.", 25, 250);
    doc.text("2. Si cede, subarrienda o transfiere a cualquier título el presente contrato.", 25, 256);
    doc.text("3. Si contrae compromisos económicos o legales que afecten los intereses del SUBARRENDADOR.", 25, 261);
    doc.text("4. Si causa inconvenientes a los vecinos, malos tratos con otros clientes o el personal de la oficina.", 25, 266);
    doc.text("5. Si hace mal uso de las instalaciones como de los servicios ofrecidos por el SUBARRENDADOR.", 25, 271);
    doc.text("6. Si no cancela dentro de los plazos el monto del arriendo.", 25, 276);
    doc.addPage();
    doc.setFont("arial");
    doc.setFontSize(10)
    ...
    doc.save(`Contrato Arriendo Provisorio para ${razon}.pdf`);
  }