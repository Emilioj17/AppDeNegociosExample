...
const FormularioClienteDt = ({ setNuevoCliente }) => {
	...
	const HandlerCrearNuevoCliente = (event) => {
		if (
			...
			datos.rutRepresentante.trim() === "" ||
			datos.fechaContratacion.trim() === "" ||
			datos.correo.trim() === ""
		) {
	...
	const HandlerCompletarDatos = (event) => {
		if (
			event.target.name === "razon" ||
			event.target.name === "representante"
		) {
	...
	return (
		...
		>
			<div className='callout' data-closable>
				...
				<div className='row'>
					...
					<div className='columns'>
						<form className='log-in-form'>
							...
							<div>
								<label htmlFor='start'>
									Fecha de Contratacion<span style={{ color: "red" }}>*</span>
								</label>
								<input
									type='date'
									id='start'
							...
							<div className='grid-x grid-margin-x'>
								...
								<div className='cell small-4'>
									<label className='form-label' htmlFor='tipoPago'>
										Que tipo de pago tendrá?
									</label>
									<select
										className='form-select'
										id='tipoPago'
							...
							{opcionesAdicionales ? (
								<div className='card-divider grid-x grid-margin-x'>
									...
									<div className='cell small-3'>
										<label className='form-label' htmlFor='sacar'>
											Sacar?
										</label>
										<select
											className='form-select'
				...
				{alertRutRepresentante ? (
					<div className='callout alert text-center'>
						Rut Representante Incorrecto
					</div>
				) : null}
				{alertFono ? (
					<div className='callout alert text-center'>
