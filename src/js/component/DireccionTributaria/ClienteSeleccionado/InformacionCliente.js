...
const InformacionCliente = () => {
    ...
    const SaldoTotal = (meses) => {
        ...
        if (store.infoClienteDt.vigente === "Si") {
            if (store.pago2019!= null && store.pago2020!= null && store.pago2021!= null && store.pago2022!=null && store.pago2023!=null && store.pago2024!=null && meses==true) {
                ...
                <div className="card-section">
                        {(store.infoClienteDt != null) ? (
                            <ul className="no-bullet">
                                ...
                                <li>Fecha Contratacion: {store.infoClienteDt.fechaContratacion} ({SaldoDeberia(false)} meses aprox.)</li>
                                ...
                                <li>Meses Pendientes: {parseInt(SaldoDeberia(false)) - parseInt(SaldoTotal(false))} meses ${(parseInt(SaldoDeberia(false)) - parseInt(SaldoTotal(false)))* 9900}</li>
                            </ul>
                            ) : (null)}
                </div>
            </div>
