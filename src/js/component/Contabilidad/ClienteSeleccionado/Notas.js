...
const Notas = ({ clienteContabilidadCliqueado, setDSetectorCambiosNotas }) => {
		...
		<div className='card'>
			...
			<div className='card-section notas'>
				<table className='table'>
					<tbody>
						{store.notaContabilidad != null
							? store.notaContabilidad.map((object, i) => (
									<tr key={i}>
			...
			<div className='column'>
				<label>
					...
					<textarea
						...
						value={nota}
						onChange={(e) => HandlerNota(e)}
					></textarea>
				</label>
				<div className='button-group align-right'>
					<button
						className='submit button'
						onClick={(e) => HandlerAgregarNota(e)}
					>
						Agregar Nota
					</button>
				</div>
