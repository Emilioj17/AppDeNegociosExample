...
const Bienvenida = () => {
	...
	const HandlerClickCalendario = (value, event) => {
		...
		if (
			value.getDate() === rodrigo.getDate() &&
			value.getMonth() === rodrigo.getMonth()
		) {
			setCelebracion({
				nombre: "Rodrigo",
				fecha: rodrigo,
		...
		if (
			value.getDate() === emilio.getDate() &&
			value.getMonth() === emilio.getMonth()
		) {
			setCelebracion({
				nombre: "Emilio",
				fecha: emilio,
		...
		if (
			value.getDate() === colomba.getDate() &&
			value.getMonth() === colomba.getMonth()
		) {
			setCelebracion({
				nombre: "Colomba",
				fecha: colomba,
		...
		if (
			value.getDate() === erick.getDate() &&
			value.getMonth() === erick.getMonth()
		) {
			setCelebracion({
				nombre: "Erick",
				fecha: erick,
		...
		if (
			value.getDate() === victor.getDate() &&
			value.getMonth() === victor.getMonth()
		) {
			setCelebracion({
				nombre: "Victor",
				fecha: victor,
		...
		if (
			value.getDate() === ricardo.getDate() &&
			value.getMonth() === ricardo.getMonth()
		) {
			setCelebracion({
				nombre: "Ricardo",
				fecha: ricardo,
		...
		if (
			value.getDate() === lucas.getDate() &&
			value.getMonth() === lucas.getMonth()
		) {
			setCelebracion({
				nombre: "Lucas",
				fecha: lucas,
		...
		if (
			value.getDate() === laura.getDate() &&
			value.getMonth() === laura.getMonth()
		) {
			setCelebracion({
				nombre: "Laura",
				fecha: laura,
		...
		if (
			value.getDate() === gislen.getDate() &&
			value.getMonth() === gislen.getMonth()
		) {
			setCelebracion({
				nombre: "Gislen",
				fecha: gislen,
		...
		if (
			value.getDate() === javiera.getDate() &&
			value.getMonth() === javiera.getMonth()
		) {
			setCelebracion({
				nombre: "Javiera",
				fecha: javiera,
		...
		if (
			value.getDate() === alejandraBarra.getDate() &&
			value.getMonth() === alejandraBarra.getMonth()
		) {
			setCelebracion({
		...
		if (
			value.getDate() === daniel.getDate() &&
			value.getMonth() === daniel.getMonth()
		) {
			setCelebracion({
				nombre: "Daniel",
				fecha: daniel,
					...
					<div className='cell small-7'>
						...
						<Calendar
							...
							tileClassName={({ date, view }) =>
								(view === "month" && date.getDate() === 20) ||
								date.getDate() === 13 ||
								(date.getDate() === rodrigo.getDate() &&
									date.getMonth() === rodrigo.getMonth()) ||
								(date.getDate() === emilio.getDate() &&
									date.getMonth() === emilio.getMonth()) ||
								(date.getDate() === colomba.getDate() &&
									date.getMonth() === colomba.getMonth()) ||
								(date.getDate() === erick.getDate() &&
									date.getMonth() === erick.getMonth()) ||
								(date.getDate() === victor.getDate() &&
									date.getMonth() === victor.getMonth()) ||
								(date.getDate() === ricardo.getDate() &&
									date.getMonth() === ricardo.getMonth()) ||
								(date.getDate() === lucas.getDate() &&
									date.getMonth() === lucas.getMonth()) ||
								(date.getDate() === laura.getDate() &&
									date.getMonth() === laura.getMonth()) ||
								(date.getDate() === gislen.getDate() &&
									date.getMonth() === gislen.getMonth()) ||
								(date.getDate() === javiera.getDate() &&
									date.getMonth() === javiera.getMonth()) ||
								(date.getDate() === alejandraBarra.getDate() &&
									date.getMonth() === alejandraBarra.getMonth()) ||
								(date.getDate() === daniel.getDate() &&
									date.getMonth() === daniel.getMonth())
									? "saturday2"
									: null
							}
						/>
					...
					<div className='cell small-3' style={{ marginLeft: "20px" }}>
						...
						<ul>
							...
							{click ? (
								<li>
									<h6>
										Dia {celebracion.fecha.getDate()} de{" "}
										{mesesNombres[celebracion.fecha.getMonth()]}:
									</h6>
									<p>
										Feliz Cumpleaños {celebracion.nombre} <FcLike />
									</p>
								</li>
							) : null}
						</ul>
